...
``` {r fig.width = 8, fig.height = 7, tidy=TRUE, tidy.opts=list(width.cutoff=60)}
hist(new_dt$Total.Volume, xlab = "Total Sold", labels = T, col = "blue", main = paste("Total Number of Observations for Avocados sold in Atlanta Boston and Detroit"))
```
...
We use boxplot:  
```{r, fig.width=8, fig.height=6, tidy=TRUE, tidy.opts=list(width.cutoff=60)}
boxplot(Total.Volume~region,data = new_dt, xlab = "Number of Avocados", ylab = "Region", col= "blue", horizontal = T)
title(main = c("Total Number of Avocados sold in Atlanta, Boston and Detroit"))
```
